...
find ${DISTNAME}/bin -type f -executable -exec ../kimoracoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../kimoracoin/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/kimoracoin/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/kimoracoin/depends/SDKs/MacOSX10.11.sdk.tar.gz
