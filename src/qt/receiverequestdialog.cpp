...
#include "config/kimora-config.h" /* for USE_QRCODE */
#endif
...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatKimoraURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + KimoraUnits::formatHtmlWithUnit(model->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatKimoraURI(info));
}
