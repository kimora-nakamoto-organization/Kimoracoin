...
#ifndef KMR_QT_KMRUNITS_H
#define KMR_QT_KMRUNITS_H
...
/** Kimora unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class KimoraUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit KimoraUnits(QObject *parent);

    /** Kimora units.
      @note Source: https://en.kimora.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        KMR,
...
typedef KimoraUnits::Unit KimoraUnit;

#endif // KMR_QT_KMRUNITS_H
