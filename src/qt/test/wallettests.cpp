...
#include "qt/kimoraamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<KimoraAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_kimora-qt -platform xcb      # Linux
//     src/qt/test/test_kimora-qt -platform windows  # Windows
//     src/qt/test/test_kimora-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = KimoraUnits::formatWithUnit(unit, balance, false, KimoraUnits::separatorAlways);
    ...
    // Amount input
    KimoraAmountField* amountInput = receiveCoinsDialog.findChild<KimoraAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: kimora:")) != -1);
