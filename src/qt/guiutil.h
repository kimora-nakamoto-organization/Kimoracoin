...
#ifndef KMR_QT_GUIUTIL_H
#define KMR_QT_GUIUTIL_H
...
/** Utility functions used by the Kimora Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "kimora:" URI into recipient object, return true on successful parsing
