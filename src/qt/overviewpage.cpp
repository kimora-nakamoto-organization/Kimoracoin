...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(KimoraUnits::KMR),
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(KimoraUnits::formatWithUnit(unit, balance, false, KimoraUnits::separatorAlways));
    ui->labelUnconfirmed->setText(KimoraUnits::formatWithUnit(unit, unconfirmedBalance, false, KimoraUnits::separatorAlways));
    ui->labelImmature->setText(KimoraUnits::formatWithUnit(unit, immatureBalance, false, KimoraUnits::separatorAlways));
    ui->labelTotal->setText(KimoraUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, KimoraUnits::separatorAlways));
    ui->labelWatchAvailable->setText(KimoraUnits::formatWithUnit(unit, watchOnlyBalance, false, KimoraUnits::separatorAlways));
    ui->labelWatchPending->setText(KimoraUnits::formatWithUnit(unit, watchUnconfBalance, false, KimoraUnits::separatorAlways));
    ui->labelWatchImmature->setText(KimoraUnits::formatWithUnit(unit, watchImmatureBalance, false, KimoraUnits::separatorAlways));
    ui->labelWatchTotal->setText(KimoraUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, KimoraUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("KMR")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the KMR balance grid from expanding and looking terrible when asset balance is hidden
