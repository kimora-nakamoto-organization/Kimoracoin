...
#ifndef KMR_QT_KMRGUI_H
#define KMR_QT_KMRGUI_H
...
/**
  Kimora GUI main class. This class represents the main window of the Kimora UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KimoraGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KimoraGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~KimoraGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a kimora wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
