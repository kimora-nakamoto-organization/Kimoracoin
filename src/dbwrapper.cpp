...
class CKimoraLevelDBLogger : public leveldb::Logger {
public:
    ...
    void Logv(const char * format, va_list ap) override {
            ...
            for (int iter = 0; iter < 2; iter++) {
                ...
                if (p < limit) {
                    ...
                    // Do not use vsnprintf elsewhere in kimora source code, see above.
...
static leveldb::Options GetOptions(size_t nCacheSize, size_t maxFileSize)
{
    ...
    options.info_log = new CKimoraLevelDBLogger();
