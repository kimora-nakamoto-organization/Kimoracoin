...
BOOST_FIXTURE_TEST_SUITE(asset_tx_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_not_valid_test)
    {
        ...
        // This should fail because 900 KMR doesn't have a destination
        CAssetTransfer assetTransfer("KMR", 100);
    ...
    BOOST_AUTO_TEST_CASE(asset_tx_multiple_assets_test)
    {
        ...
        CAssetTransfer asset2("KMRTEST", 1000);
        CScript scriptPubKey2 = GetScriptForDestination(DecodeDestination(Params().GlobalBurnAddress()));
        asset2.ConstructTransaction(scriptPubKey2);

        CAssetTransfer asset3("KMRTESTTEST", 1000);
        ...
        {
            // Add the first asset
            CAssetTransfer outAsset("KMR", 100);
            ...
            CAssetTransfer outAsset2("KMRTEST", 100);
            ...
            // Add the third asset
            CAssetTransfer outAsset3("KMRTESTTEST", 100);
        ...
        // The inputs are spending 3000 Assets (1000 of each KMR, KMRTEST, KMRTESTTEST)
        // The outputs are spending 100 Assets to 10 destinations (10 * 100 = 1000) (of each KMR, KMRTEST, KMRTESTTEST)
