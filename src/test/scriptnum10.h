...
#ifndef KMR_TEST_SCRIPTNUM10_H
#define KMR_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Kimora Core 0.10.0, for cross-comparison.
 */
public:
