...
#ifndef KMR_VALIDATION_H
#define KMR_VALIDATION_H
...
/** Block download timeout base, expressed in millionths of the block interval (i.e. 10 min) */ // TODO Should we change this for kimora, with 1 minutes block intervals?
