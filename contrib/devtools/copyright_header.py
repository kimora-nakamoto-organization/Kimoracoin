...
EXPECTED_HOLDER_NAMES = [
    ...
    "The Kimora Core developers\n",
    "The Kimora Core developers \n",
    "Kimora Core Developers\n",
    "the Kimora Core developers\n",
    "The Kimora developers\n",
    "BitPay Inc\.\n",
    "BitPay, Inc\.\n",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The Kimora Core developers'
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Kimora 
