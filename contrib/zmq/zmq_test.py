...
"""
    ...
    Kimora should be started with the command line arguments:
        kimorad -testnet -daemon \
...
while True:
	...
	if topic == b"hashblock":
		...
		while(pos != -1):
			...
			if (pos > -1):
				print("FOUND KMR issuance at " + str(pos))
				print("After KMR: " + astr[pos+6:pos+8])
			...
			pos = astr.find('72766e', start)
			if (pos > -1):
				print("FOUND KMR something at " + str(pos))
			start += pos+8
			print(astr)
