...
from test_framework.test_framework import KimoraTestFramework, SkipTest
...
class ZMQTest (KimoraTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that kimora has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("kimorad has not been built with zmq enabled.")
