...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KimoraTestFramework
    pass

class ExampleTest(KimoraTestFramework):
    # Each functional test is a subclass of the KimoraTestFramework class.
    ...
    def custom_method(self):
        ...
        KimoraTestFramework class so other tests can use it."""
