...
# TestNode: A peer we use to send messages to kimorad, and store responses.
...
class CompactBlocksTest(KimoraTestFramework):
    ...
    # This test actually causes kimorad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kimorad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kimorad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kimorad will not send blocktxn responses for blocks whose height is
