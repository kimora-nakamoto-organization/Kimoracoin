...
By default, kimorad will dump mempool on shutdown and
...
class MempoolPersistTest(KimoraTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give kimorad a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent kimorad from writing mempool.dat to disk. Verify that `savemempool` fails")
