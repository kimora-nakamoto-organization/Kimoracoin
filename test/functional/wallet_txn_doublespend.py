...
class TxnMallTest(KimoraTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 KMR:
        ...
        # First: use raw transaction API to send 1240 KMR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 KMR coin each
        ...
        # Node0's balance should be starting balance, plus 50KMR for another
        ...
        # Node0's total balance should be starting balance, plus 100KMR for 
