...
class BIP66Test(KimoraTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # kimorad is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and kimorad produces more specific reject
            # reasons.
