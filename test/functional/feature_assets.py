...
class AssetTest(KimoraTestFramework):
    ...
    def activate_assets(self):
        self.log.info("Generating KMR for node[0] and activating assets...")
    ...
    def big_test(self):
        ...
        n0.listassets(asset="KMR*", verbose=False, count=2, start=-2)
        ...
        kimora_assets = n0.listassets(asset="KMR*", verbose=False, count=2, start=-2)
        assert_equal(len(kimora_assets), 2)
        assert_equal(kimora_assets[0], "KMR2")
        assert_equal(kimora_assets[1], "KMR3")
        self.sync_all()
