...
class TestKimoraCli(KimoraTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `kimora-cli getinfo`")
        ...
        self.log.info("Compare responses from `kimora-cli -getinfo` and the RPCs data is retrieved from.")
