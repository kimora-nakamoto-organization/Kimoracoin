## Kimoracoin Metadata Specification

Additional fields may be added, but will be ignored by Kimoracoin.
...
```
{
   ...
   "contract_signature": "<Kimoracoin signed contract_hash>",
...
**forsale_price** - To give buyers an idea of the cost to own and admin the asset token.   Price followed by a space, followed by the currency.  Examples: "10000 KMR" or "0.3 BTC" or "50000 USD"  This might be parsed by token broker websites.
