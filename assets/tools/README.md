...
### IPFS Pinner
Loops through blocks and transactions and pins asset issuance meta-data and then monitors kimorad transactions for new ipfs metadata via zmq.
...
* Run kimorad or kimora-qt with parameter to use zmq: ```-zmqpubrawtx=tcp://127.0.0.1:28501```
