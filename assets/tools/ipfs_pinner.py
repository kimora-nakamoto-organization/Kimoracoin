...
#Set this to your kimora-cli program
cli = "kimora-cli"

#mode = "-testnet"
mode = ""
rpc_port = 8501
#Set this information in your kimora.conf file (in datadir, not testnet3)
rpc_user = 'rpcuser'
rpc_pass = 'rpcpass555'
	...
	for i in range(start_block,blockheight):
	    ...
	    for tx in txs:
	        ...
	        for vout in tx_detail.get('vout'):
	            if (vout.get('scriptPubKey').get('asm')[86:98] == "OP_KMR_ASSET"):
	                print_debug("Found OP_KMR_ASSET")
